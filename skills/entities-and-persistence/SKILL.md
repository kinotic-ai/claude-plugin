...
Application (portal → Application settings → **Tenant per user**), not on the project, and
`Application Service Create Application If Not Exist` cannot set it — see the create-app
skill for choosing it up front.
